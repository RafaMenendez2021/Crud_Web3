...
pub fn handler_actualizar_receta(
    ...
    // Como los ingredientes o los precios cambiaron, necesitamos volver a calcular
    // cuanto nos cuesta producir el pan.
    ...
    // Guardamos los nuevos datos en la receta existente.
